            ...
            case EVENT_KEY:
                ...
                case EVENT_TOUCH: {
                    ...
                    if (event.data.touch_single.direction == TOUCH_UP) {
                        ...
                        if (y <= 92 && y >= 62) {
                            if (x >= 240 && x <= 270) memory -= 0x100;
                            if (x >= 275 && x <= 305) memory += 0x100;
                        }

                        if (y <= 489 && y >= 459 && x <= 308 && x >= 198) {
                            MoreOptionsMenu();
                        }
                    }
                    break;
...
void initscreen() {
    ...
    Button(30, 30, 55, 494);
    Button(30, 30, 90, 494);
    Button(47, 30, 133, 494);
    Button(47, 30, 198, 494);
    Button(47, 30, 261, 494);
    Button(110, 30, 198, 459);
}
...
void hexdump() {
    ...
    for (int x = underlineLeftAscii(cursorx); x <= underlineLeftAscii(cursorx) + 6; x++)
        PIXEL(x, underlineTop(cursory)) = 0b0000011111100000;
}
